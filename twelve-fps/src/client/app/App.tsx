          ...
          {currentView === 'draw' && (
            <div className="w-full">
              <div className="flex flex-col lg:flex-row gap-6 items-start justify-center">
                {/* SidePanels a la izquierda si se elige 'left' */}
                {paletteSide === 'left' && (
                ...
                {/* Canvas + columna de controles verticales */}
                <div ref={canvasCardRef} className="flex items-start gap-4 mx-auto">
                  ...
                  {/* Controles verticales únicos (evita duplicar al cambiar de lado) */}
                  <div className="hidden sm:flex flex-col gap-2 pt-2 w-[70px]">
                ...
                {/* SidePanels a la derecha si se elige 'right' */}
                {paletteSide === 'right' && (
                  <div className="shrink-0">
                    <SidePanels
                      side={paletteSide}
