...
export const WeekVideo: React.FC<WeekVideoProps> = ({ frames, fps = 12, autoPlay = true, loop = true, title }) => {
  ...
  <div className="relative aspect-[540/740] bg-black/40 rounded-2xl overflow-hidden border border-white/20 flex items-center justify-center w-[220px] sm:w-[260px] md:w-[300px] lg:w-[340px] xl:w-[380px] transition-shadow shadow-[0_0_0_0_rgba(255,255,255,0.1)] hover:shadow-[0_0_0_3px_rgba(255,255,255,0.15)]">
