...
export const Header: React.FC<HeaderProps> = ({ currentView, setCurrentView }) => {
  ...
  return (
    <aside
      className="group/side fixed top-0 left-0 h-screen w-[60px] hover:w-[140px] transition-all duration-300 flex flex-col bg-white/10 backdrop-blur-xl border-r border-white/20 shadow-xl z-40 overflow-hidden"
    >
